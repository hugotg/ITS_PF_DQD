										...
										<dqCollectionRulesOptionNode name="{@name}">
											<dqRuleOptionWrapper>
												<xsl:for-each select="dqRuleOptionWrapper/dqPlanRulesNode">
													<dqPlanRulesNode ruleType="{if(@ruleType='Validity Rule') then 'genericRule' else 'dimensionRule'}" ruleTypeLabel="{@ruleTypeLabel}" description="{@description}" name="{@name}" code="{@code}" type="{@type}">
														<xsl:copy-of select="ruleColumnWrapper"/>
													</dqPlanRulesNode>							
												</xsl:for-each>
												<xsl:for-each select="dqRuleOptionWrapper/dqExpressionRulesNode">
													<dqExpressionRulesNode ruleType="{if(@ruleType='Validity Rule') then 'genericRule' else 'dimensionRule'}" ruleTypeLabel="{@ruleTypeLabel}" description="{@description}" name="{@name}" code="{@code}" type="{@type}">
														<xsl:copy-of select="ruleColumnWrapper"/>
												...
												<xsl:for-each select="dqRuleOptionWrapper/dqMultiEntityExpressionRulesNode">
													<dqMultiEntityExpressionRulesNode ruleType="{if(@ruleType='Validity Rule') then 'genericRule' else 'dimensionRule'}" ruleTypeLabel="{@ruleTypeLabel}" description="{@description}" name="{@name}" code="{@code}" type="{@type}">
												...
												<xsl:for-each select="dqRuleOptionWrapper/dqCopyRulesNode">
													<dqCopyRulesNode ruleType="{if(@ruleType='Validity Rule') then 'genericRule' else 'dimensionRule'}" ruleTypeLabel="{@ruleTypeLabel}" description="{@description}" name="{@name}" inputColumn="{@inputColumn}" code="{@code}" type="{@type}"/>				
												</xsl:for-each>
											</dqRuleOptionWrapper>					
											<!-- LOOP -->
													...
													<lMTableNode name="{@name}">
														<lMAttributeWrapper>
															<xsl:for-each select="lMAttributeWrapper/lMAttributeNode">
																...
																<xsl:variable name="newRuleType" select="if($ruleType='Validity Rule') then 'genericRule' else 'dimensionRule'"/>
										...
										<collectionRulesOptionNode name="{@name}">
											<ruleOptionWrapper>
												<xsl:for-each select="ruleOptionWrapper/planRulesNode">
													<planRulesNode ruleType="{if(@ruleType='Validity Rule') then 'genericRule' else 'dimensionRule'}" ruleTypeLabel="{@ruleTypeLabel}" planFile="{@planFile}" name="{@name}" code="{@code}" type="{@type}">
														<xsl:copy-of select="description"/>
														<xsl:copy-of select="ruleColumnWrapper"/>
												...
												<xsl:for-each select="ruleOptionWrapper/expressionRulesNode">
													<expressionRulesNode ruleType="{if(@ruleType='Validity Rule') then 'genericRule' else 'dimensionRule'}" ruleTypeLabel="{@ruleTypeLabel}" name="{@name}" code="{@code}" type="{@type}">
													<xsl:copy-of select="description"/>
													<xsl:copy-of select="ruleColumnWrapper"/>
													<xsl:copy-of select="ruleExplanationWrapper"/>					
												</expressionRulesNode>
												...
												<xsl:for-each select="ruleOptionWrapper/multiEntityExpressionRulesNode">
													<multiEntityExpressionRulesNode  ruleType="{if(@ruleType='Validity Rule') then 'genericRule' else 'dimensionRule'}" ruleTypeLabel="{@ruleTypeLabel}" name="{@name}" code="{@code}" type="{@type}">
														<xsl:copy-of select="description"/>
												...
												<xsl:for-each select="ruleOptionWrapper/copyRulesNode">
													<copyRulesNode ruleType="{if(@ruleType='Validity Rule') then 'genericRule' else 'dimensionRule'}" ruleTypeLabel="{@ruleTypeLabel}" name="{@name}" inputColumn="{@inputColumn}" code="{@code}" type="{@type}">
														<xsl:copy-of select="description"/>
														<xsl:copy-of select="ruleExplanationWrapper"/>
													</copyRulesNode>						
												</xsl:for-each>
